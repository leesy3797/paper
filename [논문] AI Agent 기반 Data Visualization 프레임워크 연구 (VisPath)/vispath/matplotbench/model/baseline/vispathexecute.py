...
"""
        ...
        - **Code for Aggregation with Code Executability**: Three different versions of the data visualization code, each paired with its respective **code executability status** (True if executable without errors, False otherwise).
        ...
        2. **Evaluate the Provided Code Versions & Executability**  
        - Examine all three versions of the code.
        - For each version, check its executability status (True or False).
        
        3. **Synthesize the Best Final Version**  
        - Construct a final version that effectively **integrates the best aspects** of the executable codes.
        ...
        - **Data Description:** {data_description}
        - **Code for Aggregation with Corresponding Executability:** {code_for_aggregation}
        """
